...
class ParameterBridge {
  ...
  // Update sources - moved outside class
  // enum UpdateSource { ui, audio, visualizer }
...
mixin ParameterBridgeMixin<T extends StatefulWidget> on State<T> {
  ...
  void onParameterUpdate(String name, double value, UpdateSource source) {}
  ...
  void updateParameter(String name, double value) {
    _bridge.updateParameter(name, value, UpdateSource.ui);
  }
}