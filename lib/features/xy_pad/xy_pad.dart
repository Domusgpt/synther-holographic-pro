...
class _XYPadState extends State<XYPad> {
  ...
  late SynthParametersModel _synthParams;
  ...
  void initState() {
    ...
    // Get synth parameters from provider
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _synthParams = Provider.of<SynthParametersModel>(context, listen: false);
    });
  ...
  Future<void> _initSynthEngine() async {
    try {
      // Synth engine is initialized by the provider
    } catch (e) {
